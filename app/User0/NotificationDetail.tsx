        ...
        {notificationB ? (
          <>
            ...
            <Text style={styles.Verified}>
              {notificationB.ApprovedByChiefMOC}
            </Text>
            <View style={styles.line} />
            <Text style={styles.incharge}>Approved by Chief Engineer MOC</Text>
          </>
        ) : (
          <Text style={styles.noData}>No Block B data available</Text>
        )}
       
        {verify ? <BlockC path={path} userName={userName} /> :  <Button onClick={handleSubmit(OnClickVerify)}>
          Verify Notification
        </Button>}
      </View>
    </ScrollView>
